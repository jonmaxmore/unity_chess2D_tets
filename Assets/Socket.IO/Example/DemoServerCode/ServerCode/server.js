...
var port = process.env.PORT || '16033';
app.set('port', port);
...
var socketServer = require("https").createServer(app);

var socketPort = 3001;
socketServer.listen(socketPort, '0.0.0.0', function() {
  console.log("Listen " + socketPort);
})


const io = require('socket.io')(socketPort, { //8123 is the local port we are binding the demo server to
